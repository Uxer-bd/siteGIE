...
// Définition de l'interface Participant
...
@Component({
    selector: 'app-pi-succes',
    templateUrl: './pi-succes.component.html',
    styleUrls: ['./pi-succes.component.css']
})
export class PiSuccesComponent {
    showPopup = false;
    popupTitle = '';
    popupContent = '';
    popupImage = '';
